...
#ifndef TFLM_BENCHMARK_OP_RESOLVER_NO_SIGNAL_H_
#define TFLM_BENCHMARK_OP_RESOLVER_NO_SIGNAL_H_
...
using TflmOpResolverNoSignal = MicroMutableOpResolver<101>;

inline TfLiteStatus CreateOpResolverNoSignal(
  ...
  // TF_LITE_ENSURE_STATUS(op_resolver.AddCircularBuffer()); // Signal op
  TF_LITE_ENSURE_STATUS(op_resolver.AddConcatenation());
  TF_LITE_ENSURE_STATUS(op_resolver.AddConv2D());
  TF_LITE_ENSURE_STATUS(op_resolver.AddCos());
  TF_LITE_ENSURE_STATUS(op_resolver.AddCumSum());
  // TF_LITE_ENSURE_STATUS(op_resolver.AddDecode()); // New op
  // TF_LITE_ENSURE_STATUS(op_resolver.AddDelay()); // Signal op
  ...
  // TF_LITE_ENSURE_STATUS(op_resolver.AddDynamicUpdateSlice()); // New op
  TF_LITE_ENSURE_STATUS(op_resolver.AddElu());
  TF_LITE_ENSURE_STATUS(op_resolver.AddEmbeddingLookup());
  // TF_LITE_ENSURE_STATUS(op_resolver.AddEnergy()); // Signal op
  ...
  // TF_LITE_ENSURE_STATUS(op_resolver.AddFftAutoScale()); // Signal op
  TF_LITE_ENSURE_STATUS(op_resolver.AddFill());
  // TF_LITE_ENSURE_STATUS(op_resolver.AddFilterBank()); // Signal op
  // TF_LITE_ENSURE_STATUS(op_resolver.AddFilterBankLog()); // Signal op
  ...
  // TF_LITE_ENSURE_STATUS(op_resolver.AddFramer()); // Signal op
  ...
  // TF_LITE_ENSURE_STATUS(op_resolver.AddIrfft()); // Signal op
  ...
  // TF_LITE_ENSURE_STATUS(op_resolver.AddOverlapAdd()); // Signal op
  // TF_LITE_ENSURE_STATUS(op_resolver.AddPCAN()); // Signal op
  ...
  // TF_LITE_ENSURE_STATUS(op_resolver.AddReduceMin()); // New op
  ...
  // TF_LITE_ENSURE_STATUS(op_resolver.AddReverseV2()); // New op
  // TF_LITE_ENSURE_STATUS(op_resolver.AddRfft()); // Signal op
  ...
  // TF_LITE_ENSURE_STATUS(op_resolver.AddStacker()); // Signal op
  ...
  // TF_LITE_ENSURE_STATUS(op_resolver.AddWindow()); // Signal op
...
#endif  // TFLM_BENCHMARK_OP_RESOLVER_NO_SIGNAL_H_
